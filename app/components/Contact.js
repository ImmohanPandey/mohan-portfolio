      ...
      <div className="py-32 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
            ...
            {/* Email */}
            <a
              href="mailto:Mohanpandey7557@gmail.com"
              className="group"
            >
              <div className="p-8 rounded-3xl border border-zinc-800 bg-zinc-950 hover:border-zinc-600 transition-all">
